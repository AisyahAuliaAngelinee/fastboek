	...
	return (
		<View style={styles.container}>
			...
			<TouchableOpacity style={styles.registerBtn}>
				<Text style={styles.registerText} onPress={() => navigation.navigate("Home")}>
					Login
				</Text>
			</TouchableOpacity>
			<Text style={{ marginTop: 10 }}>
				Don't have an account?
				<Text style={{ fontWeight: "bold", color: "blue", fontFamily: "AvenirNext-DemiBold" }} onPress={() => navigation.navigate("Register")}>
					{" "}
					Register
				</Text>
			</Text>
